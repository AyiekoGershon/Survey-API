-- Sky Survey Database Schema - Supabase (PostgreSQL) Version
-- This schema is ready to run directly in Supabase SQL Editor
-- No need to create the database - Supabase provides it
...
-- ALTER TABLE answer_texts ENABLE ROW LEVEL SECURITY;
